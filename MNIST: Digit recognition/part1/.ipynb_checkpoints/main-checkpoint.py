...
#print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=0.0000000001))
...
#print('For T = 0.5, softmax test_error=', run_softmax_on_MNIST(temp_parameter=0.5))
#print('For T = 2, softmax test_error=', run_softmax_on_MNIST(temp_parameter=2))
#print('For T = 1, softmax test_error=', run_softmax_on_MNIST(temp_parameter=1))
...
#print('For T = 1, softmax test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
#######################################################################
...
#print('For T = 1 and n=18, softmax test_error=', run_softmax_on_MNIST_pca(temp_parameter=1, n_components=18))
...
def run_softmax_on_MNIST_pca(temp_parameter=1, n_components = 18):
    ...
    train_x_centered, feature_means = center_data(train_cube)
    pcs = principal_components(train_x_centered)
    train_pca = project_onto_PC(train_cube, pcs, n_components, feature_means)
    test_pca = project_onto_PC(test_cube, pcs, n_components, feature_means)
    ...
    return test_error
print("Test error on 10D cubic PCA :",run_softmax_on_MNIST_pca(temp_parameter=1, n_components=10))